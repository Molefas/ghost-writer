...
export function createContent(storage) {
    return tool(async (input) => {
        ...
        name: 'createContent',
        description: 'Gather source materials and create a new content draft (article, LinkedIn post, or X post). Returns gathered materials — use them to generate the content, then call updateContent to save the draft body.',
        schema: z.object({
            type: z
